...
const publicRoutes = [
  ...
  "/frontend/weekend-visits",
  "/frontend/verified-properties-page",
  "/frontend/flats-for-sale-page",
  "/frontend/plots-for-sale-page",
  "/frontend/rental-properties-page",
  "/frontend/new-projects-page",
  "/frontend/ready-to-move-page",
  "/frontend/top-trusted-properties-page",
  "/frontend/first-time-buyer-page",
  "/frontend/family-decision-stories-page",
  "/frontend/budget-to-dream-home-page",
  "/frontend/contact-us",
  "/frontend/news",
  "/frontend/seo-data",
  "/api/ai",
