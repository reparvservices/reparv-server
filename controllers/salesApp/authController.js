...
export const sendsalespersonsOtp = async (req, res) => {
  ...
  const checkQuery = "SELECT * FROM salespersons WHERE contact = ?";
  ...
  db.query(checkQuery, [mobile], (err, result) => {
    ...
    const updateQuery = "UPDATE salespersons SET otp = ? WHERE contact = ?";
...
export const verifysalespersonsOtp = (req, res) => {
  ...
  const query = "SELECT * FROM salespersons WHERE contact = ? AND otp = ?";
  ...
  db.query(query, [mobile, otp], (err, result) => {
    ...
    const clearOtpQuery =
      "UPDATE salespersons SET otp = NULL WHERE contact = ?";
